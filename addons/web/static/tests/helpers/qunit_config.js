 ...
 * QUnit Config
 *
 * The WETH javascript test framework is based on QUnit (http://qunitjs.com/).
 ...
 *
 * Note that it is not an WETH module, because we want this code to be executed
 * as soon as possible, not whenever the WETH module system feels like it.
 */
