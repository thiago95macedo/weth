...
copy_raspios () {
    ...
    wget -c 'https://nightly.weth.com.br/master/iotbox/iotbox-latest.zip' -O raspios/iotbox-latest.zip
    wget -c 'https://nightly.weth.com.br/master/iotbox/SHA1SUMS.txt' -O raspios/SHA1SUMS.txt
    cd raspios/
