...
class PaypalForm(PaypalCommon):
    ...
    def test_10_paypal_form_render(self):
        ...
        self.paypal.write({'paypal_email_account': 'tde+paypal-facilitator@weth.com.br', 'fees_active': False})
        ...
        form_values = {
            'cmd': '_xclick',
            'business': 'tde+paypal-facilitator@weth.com.br',
    ...
    def test_20_paypal_form_management(self):
        ...
        paypal_post_data = {
            ...
            'mc_currency': u'EUR',
            'shipping': u'0.00',
            'payer_email': u'tde+buyer@weth.com.br',
