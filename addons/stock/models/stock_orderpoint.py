...
class StockWarehouseOrderpoint(models.Model):
    ...
    product_min_qty = fields.Float(
        ...
        help="When the virtual stock equals to or goes below the Min Quantity specified for this field, WETH generates "
             "a procurement to bring the forecasted quantity to the Max Quantity.")
    product_max_qty = fields.Float(
        'Max Quantity', digits='Product Unit of Measure', required=True, default=0.0,
        help="When the virtual stock goes below the Min Quantity, WETH generates "
