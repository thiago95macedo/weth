...
Mais especificamente ele:
  * mapea os campos de NF-e do módulo ``l10n_br_nfe_spec`` com os campos WETH em especial os campos dos módulos ``l10n_br_base`` e ``l10n_br_fiscal``
...
Módulos relacionados:
  ...
  * existe também o módulo ``l10n_br_delivery_nfe`` que faz a integração do módulo ``l10n_br_nfe`` com o módulo ``delivery`` do WETH (tags de transportadora e de frete em especial)
