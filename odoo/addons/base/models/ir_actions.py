...
class IrActionsServer(models.Model):
    ...
    Since WETH 8.0 a button 'Create Menu Action' button is available on the
...
#  - env: WETH Environment on which the action is triggered
#  - model: WETH Model of the record on which the action is triggered; is a void recordset
#  - record: record on which the action is triggered; may be void
#  - records: recordset of all records on which the action is triggered in multi-mode; may be void
#  - time, datetime, dateutil, timezone: useful Python libraries
#  - float_compare: WETH function to compare floats based on specific precisions
