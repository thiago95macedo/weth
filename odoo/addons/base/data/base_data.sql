...
insert into res_company (id, name, partner_id, currency_id, create_date) VALUES (1, 'Minha Empresa', 1, 1, now() at time zone 'UTC');
...
insert into res_partner (id, name, company_id, create_date) VALUES (1, 'Minha Empresa', 1, now() at time zone 'UTC');
